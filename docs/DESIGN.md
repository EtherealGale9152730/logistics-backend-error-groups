...
> Design notes for **logistics-backend-error-groups** — a runnable python example that Capture and group privacy-conscious backend errors in a Python shipment worker.
...
- **Feature code** — the actual task: logistics-error-tracking.
